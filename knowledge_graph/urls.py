...
urlpatterns = [
    ...
    path('memory/review-gaps/', views.review_memory_gaps, name='review_memory_gaps'),
    path('memory/review-handoff/', views.memory_review_handoff, name='memory_review_handoff'),
