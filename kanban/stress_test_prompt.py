...
STRESS_TEST_SYSTEM_PROMPT = (
    ...
    "}\n\n"
    "RULES:\n"
    "- ALWAYS return exactly 5 chaos_scenarios and exactly 5 vaccines. No exceptions. Never fewer.\n"
...
def build_stress_test_user_prompt(board_data):
    ...
    return (
        ...
        "SCORE CREDIT — VACCINES APPLIED IN PRIOR SESSIONS:\n"
        ...
        "Return exactly 5 chaos_scenarios and exactly 5 vaccines (one vaccine per scenario).\n"
