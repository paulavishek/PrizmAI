...
# Maximum projects a demo user can create
DEMO_PROJECT_LIMIT = 2

# Maximum AI generations allowed in demo mode
DEMO_AI_GENERATION_LIMIT = 20

# Whether exports are allowed in demo mode
DEMO_ALLOW_EXPORTS = False
