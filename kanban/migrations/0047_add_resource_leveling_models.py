...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('kanban', '0046_alter_projectstakeholder_unique_together_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('involvement_type', models.CharField(choices=[('owner', 'Task Owner'), ('contributor', 'Contributor'), ('reviewer', 'Reviewer'), ('approver', 'Approver/Decision Maker'), ('observer', 'Observer/Monitor'), ('beneficiary', 'Beneficiary'), ('impacted', 'Impacted Party')], default='stakeholder', help_text='Type of stakeholder involvement in task', max_length=20)),
