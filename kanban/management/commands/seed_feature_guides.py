...
FEATURE_GUIDES = [
    ...
    # own inline guidance.
    {
        ...
        'detailed_description': (
            ...
            '<div class="fw-semibold small mt-2" style="color:#3730a3 !important;">Projects run</div>'
            '<div style="font-size:0.72rem;color:#4338ca !important;">Tasks, risks, conflicts,<br>scope changes</div>'
            '</div>'
            '</div>'
            ...
            '<div style="font-size:1.8rem;line-height:1;"></div>'
            '<div class="fw-semibold small mt-2" style="color:#5b21b6 !important;">Memory builds</div>'
            '<div style="font-size:0.72rem;color:#6d28d9 !important;">AI auto-captures<br>every key event</div>'
            '</div>'
            '</div>'
            ...
            '<div style="font-size:1.8rem;line-height:1;"></div>'
            '<div class="fw-semibold small mt-2" style="color:#9a3412 !important;">You ask</div>'
            '<div style="font-size:0.72rem;color:#c2410c !important;">Natural language<br>questions, anytime</div>'
            '</div>'
            '</div>'
            ...
            '<div style="font-size:1.8rem;line-height:1;"></div>'
            '<div class="fw-semibold small mt-2" style="color:#166534 !important;">AI answers</div>'
            '<div style="font-size:0.72rem;color:#15803d !important;">Cited sources,<br>confidence score</div>'
            '</div>'
            '</div>'
            ...
            '<div class="col-6">'
            '<div class="rounded p-2" style="background:#f8fafc;border:1px solid #e2e8f0;font-size:0.78rem;color:#334155 !important;">'
            ...
            '<strong style="font-size:0.82rem;color:#78350f !important;">Tip:</strong> '
            '<span style="font-size:0.82rem;color:#92400e !important;">'
