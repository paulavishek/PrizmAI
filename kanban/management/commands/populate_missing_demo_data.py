        ...
        items = [
            {
                ...
                'description': 'The User Registration Flow task (assigned to Priya Sharma) is 9 days past its due date with 80% progress. Consider reallocating resources or adjusting the deadline.',
                'suggested_action': 'Schedule a focused pairing session with Marcus to resolve remaining 20%. Alternatively, split the remaining work into a separate task.',
                'context_data': {'task_id': 8263, 'days_overdue': 9, 'progress': 80, 'assigned_to': 'Priya Sharma'},
                'status': 'pending',
                'estimated_minutes': 5,
            },
            {
                ...
                'suggested_action': 'Assign to Priya Sharma who has database expertise, or redistribute current workload to free up capacity.',
            ...
            },
            {
                ...
                'title': 'Marcus Chen has 10 tasks - above team average',
                'description': 'Marcus Chen is assigned to 10 tasks (team avg: 8.7). Three tasks are in high-priority status. Consider load balancing.',
                'suggested_action': 'Review Marcus\'s task list and consider moving API Rate Limiting or Performance Optimization to Elena.',
                'context_data': {'user': 'Marcus Chen', 'task_count': 10, 'high_priority': 3, 'team_avg': 8.7},
                'status': 'pending',
                'estimated_minutes': 3,
            },
            {
                ...
                'suggested_action': 'Expedite the code review. Tag Elena for a second pair of eyes.',
            ...
            },
            {
                ...
                'suggested_action': 'Discuss with Priya whether to include WCAG audit in current sprint or defer to post-launch.',
            ...
            },
            {
                ...
                'suggested_action': 'Assign Notification Service to Elena and keep Search with Marcus. Both can proceed independently.',
    ...
    def _create_stakeholders(self):
        ...
        stakeholders = [
            ...
            },
            {
                ...
                'desired_engagement': 'involve',
                'notes': 'Designed the dashboard wireframes. Available for UI/UX Polish and Accessibility Compliance tasks. Meets with Elena weekly.',
                'created_by': self.jordan,
            },
            {
                'name': 'Rachel Torres',
        ...
        engagement_specs = [
            ...
            ('James Wilson',     38,  'chat',    'Notification Service queue encryption query.',
             'Flagged at-rest encryption requirement. Marcus to raise ticket.',
