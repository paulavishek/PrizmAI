    ...
    try:
        ...
        if not board_lines:
            ...
            prompt = (
                ...
                f"Synthesise the following board-level summaries for the strategy "
                f'"{strategy.name}" (mission: "{strategy.mission.name}") '
                f"into one concise strategy-level summary (3–5 sentences).\n"
                f"Focus on: strategic progress, cross-board risks and dependencies, "
